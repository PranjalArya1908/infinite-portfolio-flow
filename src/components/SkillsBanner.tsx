...
const SkillsBanner = () => {
  ...
  const headerParallax = useParallaxTransform(-0.1);
  const skillsParallax = useParallaxTransform(0.05);
  ...
  return (
    <section id="skills" className="py-20 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-900 dark:to-gray-800 overflow-hidden relative">
      ...
      <div 
        ...
        style={{ ...headerParallax, transform: `${headerParallax.transform} translateX(-30px)` }}
      ></div>
      
      <div className="container mx-auto px-6 mb-12" style={headerParallax}>
      ...
      <div className="relative" style={skillsParallax}>
